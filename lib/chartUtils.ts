...
export const chartColors = {
  ...
  amber: {
    ...
    stroke: "stroke-amber-400 dark:stroke-amber-400",
    fill: "fill-amber-400 dark:fill-amber-400",
    text: "text-amber-400 dark:text-amber-400",
  },
  yellow: {
    bg: "bg-yellow-300 dark:bg-yellow-300",
    stroke: "stroke-yellow-300 dark:stroke-yellow-300",
    fill: "fill-yellow-300 dark:fill-yellow-300",
